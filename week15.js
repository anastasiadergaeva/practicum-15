...
for (let i = 0; i < sentences.length; i++) {
    const newArr = sentences[i].split(' ');
...
for (let i = 0; i < list.length; i++) {
    console.log(`Длина слова ${list[i]}: ${list[i].length}`);
}
//Задание 14
// Преобразуйте массив каждый элемент массива words в верхний регистр
const helloWords = ['Hello', 'world', '!'];
for (let i = 0; i < helloWords.length; i++) {
    console.log(helloWords[i].toUpperCase());
}
//Задание 15
